...
const menu = [
  ...
  },
  {
    ...
    price: 8.99,
    img:
      "https://cdn.loveandlemons.com/wp-content/uploads/2020/03/bibimbap.jpg",
...
// Menü öğelerini oluşturma fonksiyonu
function displayMenuItems(menuItemsArray) {
  let displayMenu = menuItemsArray.map(item => {
    return `
...
// Sayfa yüklendiğinde menü öğelerini ve butonları oluştur
